...
public class ConsumerService {
    ...
    public void sendEmail(String text){
        try {
            ...
            helper.setFrom("latifairwandaa@gmail.com");
            helper.setTo("citipaaaa@gmail.com");
            ...
            String html =
                "<div style='font-family:Arial'>" +
                    ...
                    "<h2 style='color:blue'>Anda Telah Order di Tipa store </h2>" +
                    ...
                    "<br><br>" +
                    "<p>Terima kasih sudah order di Tipa Store<br>" +
                    "<br>" +
